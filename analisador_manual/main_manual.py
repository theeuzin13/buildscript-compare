...
# Dicionário de tradução de tokens para a listagem acadêmica 
TOKEN_NAMES_PT = {
...
def format_tokens(tokens: list[dict]) -> str:
    """Formata os tokens no padrão estrito de saída do professor."""
    formatted = []
    for t in tokens:
        if t['token'] == 'EOF':
            continue
...
POWER_OFF;"""
    ...
    # 2. Caso com Erro Léxico (Variável iniciada com número $1a)
    code_error = """POWER_ON;
SLOT $1a = 8;
POWER_OFF;"""
    ...
    # 3. Caso com Erro Léxico (Símbolo inválido @)
