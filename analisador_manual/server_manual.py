"""
Servidor local para a IDE do Analisador Léxico MANUAL.
Serve index_manual.html e expõe o endpoint POST /run_manual
que executa o ManualLexer e retorna os tokens formatados.
Usa apenas bibliotecas padrão do Python (http.server, json, io).
"""
import http.server
import socketserver
import json
...
class ManualIDEHandler(http.server.BaseHTTPRequestHandler):
    ...
    def log_message(self, format, *args):
        pass  # Silencia o log padrão para manter o terminal limpo
